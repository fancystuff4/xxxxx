...
export class ProductService {
    ...
    async deleteProduct(subCategoryId,productId) {    
      const result : any = await InvokeAPI(`/subCategories/${subCategoryId}/products/${productId}`, 'delete',undefined , undefined, 3000);
      return result;
    }
    ...
    async updateProductStatus(body,subCategoryId,productId) {  
        const result : any = await InvokeAPI(`/subCategories/${subCategoryId}/products/${productId}/active`, 'put', body, undefined, 3000);
        return result;
      }

    async addProductImages(body,subCategoryId,productId) {  
        const result :  any = await InvokeAPI(`/subCategories/${subCategoryId}/products/${productId}/images`, 'post', body, undefined, 3000);
        return result;
      }

    async getOneProductImage(subCategoryId,productId,imageId) {  
        const result :  any = await InvokeAPI(`/subCategories/${subCategoryId}/products/${productId}/images/${imageId}`, 'get', undefined, undefined, 3000);
        return result;
      }

    async getProductImages(subCategoryId,productId) {  
        const result :  any = await InvokeAPI(`/subCategories/${subCategoryId}/products/${productId}/images`, 'get', undefined, undefined, 3000);
        return result;
      }

    async deleteProductImage(subCategoryId,productId,imageId) {  
        const result :  any = await InvokeAPI(`/subCategories/${subCategoryId}/products/${productId}/images/${imageId}`, 'delete', undefined, undefined, 3000);
        return result;
      }
