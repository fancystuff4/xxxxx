...
class CartController {
  ...
  async getUserCart(@Response() res: any, @Request() req: any): Promise<any> {
    let userId = '';
  ...
  async removeUserCartItem(
    ...
    const result = await this.cartService.removeUserCartItem(
      userId,
      cartId,
      lineItemId,
    );
  ...
  async modifyUserCartItem(
    ...
    const result = await this.cartService.modifyUserCartItem(
      userId,
      cartId,
      lineItemId,
      body,
