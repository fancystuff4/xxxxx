...
class TenantController {
  ...
  async updateTenantStatus(
    ...
    const result: any = await this.tenantService.updateTenantStatus(
      tenantId,
      body,
    );
    return res.status(result.statusCode).json(result);
  ...
  async addPaymentService(
    ...
    const result: any = await this.tenantService.addPaymentService(
      superAdminId,
      body,
    );
    return res.status(result.statusCode).json(result);
  ...
  async editPaymentService(
    ...
    const result: any = await this.tenantService.editPaymentService(
      superAdminId,
      serviceName,
      body,
    );
  ...
  async addTenantPaymentCredentials(
    ...
    const result: any = await this.tenantService.addTenantPaymentCredentials(
      superAdminId,
      tenantId,
      body,
    );
  ...
  async removeTenantPaymentCredentials(
    ...
    const result: any = await this.tenantService.removeTenantPaymentCredentials(
      tenantId,
      serviceName,
    );
    return res.status(result.statusCode).json(result);
